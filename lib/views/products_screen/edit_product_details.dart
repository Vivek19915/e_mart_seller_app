...
class EditProductDetails extends StatelessWidget {
  final dynamic data;
  const EditProductDetails({super.key, this.data});

  @override
  Widget build(BuildContext context) {

    var productController  = Get.find<ProductsController>();
    productController.pnameController.text = data['p_name'].toString();
    productController.pdescController.text = data['p_desc'].toString();
    productController.ppriceController.text = data['p_price'].toString();
    productController.pquantityController.text = data['p_quantity'].toString();
            ...
            bottomNavigationBar: SizedBox(
              ...
              child: productController.isloading.value
                  ...
                  : ourButton(color: white , onPress: ()async{
                      ...
                      //adding that edited product on firebase ----------->
                      await productController.uploadProductDetails(context);
                      //removing the current product from firebase------------->
                      await productController.removeProduct(data.id);
              ...
              } , title: "Save Changes",textcolor: purpleColor),
            ),

            appBar: AppBar(
              automaticallyImplyLeading: false,
              title: boldText(text: "Edit product Details",color: white,size: 18.0,),
            ),
